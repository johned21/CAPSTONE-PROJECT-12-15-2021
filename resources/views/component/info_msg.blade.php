...
<script>
    $(document).ready(function(){
       $("#warnmsg_modal").modal("show"); 
    });
    
    setTimeout(function(){
       $("#warnmsg_modal").modal("hide")
    }, 3000);
 </script>
 
<div class="modal fade bd-example-modal-sm" id="warnmsg_modal" tabindex="-1" role="dialog" aria-labelledby="success_reg_modal" aria-hidden="true">
    <div class="modal-dialog modal-sm text-center">
        <div class="modal-content">
            <p class="mt-3"><i style="font-size: 5em;" class="fal fa-exclamation-circle text-info"></i></p>
            <h5 style="margin-top:-3%; color: rgb(46, 46, 46)">Notice</h5>
            <p class="text-dark">{{ $notice }}</p>
            <p><button type="button" data-dismiss="modal" aria-label="Close" class="btn ok-close-btn">OK</button></p>
        </div>
